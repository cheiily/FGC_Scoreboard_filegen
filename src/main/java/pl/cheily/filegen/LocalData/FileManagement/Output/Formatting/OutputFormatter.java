 ...
 *  That ability however is currently not presented by the GUI in order to simplify the user experience - instead a number of presets is presented in the form of Formatters to choose from. <<< WIP
